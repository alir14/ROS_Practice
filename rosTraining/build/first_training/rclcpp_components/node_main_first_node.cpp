...
#define NODE_MAIN_LOGGER_NAME "first_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "first_training.dll";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<first_training::FirstNode>";
